...
namespace SentimentSuite_TrainerUI
{
    public partial class SentimentMLModel
    {
        public const string RetrainFilePath =  @"D:\Practice\MLNET\Projects\Sentiment\SentimentSuite\SentimentSuite.TrainerUI\DataSet\SentimentTrainingData.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"SentimentText",outputColumnName:@"SentimentText")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.34847364F,L2Regularization=2.4602723F,LabelColumnName=@"Label",FeatureColumnName=@"Features"}))      
